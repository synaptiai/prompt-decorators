...
DECORATOR_FILE = Path(__file__).resolve().parent.parent.parent / "registry/core/structure/comparison.json"
...
def run_tests():
    ...
    test_configurations = [
        {"params": {}, "description": "Default parameters (table format with highlighting)"},
        {"params": {"format": "prose", "highlight": False}, "description": "Prose format without highlighting"},
        {"params": {"aspects": ["learning curve", "job market", "community support", "performance"], "format": "bullets"}, "description": "Bullets with specific aspects"}
    ]
