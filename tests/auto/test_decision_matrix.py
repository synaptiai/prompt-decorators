...
class TestDecisionMatrix:
    ...
    def test_initialization_default_params(self, load_decorator):
        ...
        assert decorator.name == "DecisionMatrix"

    def test_options_type_validation(self, load_decorator):
        """Test options type validation."""
        decorator_class = load_decorator("DecisionMatrix")
        assert decorator_class is not None
    ...
    def test_weighted_type_validation(self, load_decorator):
        """Test weighted type validation."""
        decorator_class = load_decorator("DecisionMatrix")
        assert decorator_class is not None
        params = self._get_valid_params()
    ...
    def test_metadata(self, load_decorator):
        ...
        assert metadata["name"] == "DecisionMatrix"
