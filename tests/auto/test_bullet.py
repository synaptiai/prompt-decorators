...
class TestBullet:
    ...
    def test_indented_type_validation(self, load_decorator):
        """Test indented type validation."""
        decorator_class = load_decorator("Bullet")
        assert decorator_class is not None
        params = self._get_valid_params()
    ...
    def test_compact_type_validation(self, load_decorator):
        """Test compact type validation."""
        decorator_class = load_decorator("Bullet")
        assert decorator_class is not None
        params = self._get_valid_params()
