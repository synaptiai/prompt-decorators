...
class TestAbductive:
    ...
    def test_initialization_default_params(self, load_decorator):
        ...
        assert decorator.name == "Abductive"

    def test_hypotheses_type_validation(self, load_decorator):
        """Test hypotheses type validation."""
        decorator_class = load_decorator("Abductive")
        assert decorator_class is not None
    ...
    def test_hypotheses_min_validation(self, load_decorator):
        """Test hypotheses minimum value validation."""
        decorator_class = load_decorator("Abductive")
        assert decorator_class is not None
        params = self._get_valid_params()
        params['hypotheses'] = 1
    ...
    def test_hypotheses_max_validation(self, load_decorator):
        """Test hypotheses maximum value validation."""
        decorator_class = load_decorator("Abductive")
        assert decorator_class is not None
        params = self._get_valid_params()
        params['hypotheses'] = 6
    ...
    def test_rank_type_validation(self, load_decorator):
        """Test rank type validation."""
        decorator_class = load_decorator("Abductive")
        assert decorator_class is not None
        params = self._get_valid_params()
        params['rank'] = 'invalid'
    ...
    def test_metadata(self, load_decorator):
        ...
        assert metadata["name"] == "Abductive"
