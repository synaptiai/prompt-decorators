...
class TestAcademic:
    ...
    def test_initialization_default_params(self, load_decorator):
        ...
        assert decorator.name == "Academic"
    ...
    def test_citationStyle_type_validation(self, load_decorator):
        """Test citationStyle type validation."""
        decorator_class = load_decorator("Academic")
        assert decorator_class is not None
        params = self._get_valid_params()
    ...
    def test_citationStyle_enum_validation(self, load_decorator):
        """Test citationStyle enum value validation."""
        decorator_class = load_decorator("Academic")
        assert decorator_class is not None
        params = self._get_valid_params()
        params['citationStyle'] = 'invalid_enum_value'
