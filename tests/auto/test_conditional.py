...
class TestConditional:
    ...
    def test_initialization_default_params(self, load_decorator):
        ...
        assert decorator.name == "Conditional"

    def test_if_param_required(self, load_decorator):
        """Test that if_param is required."""
        decorator_class = load_decorator("Conditional")
        assert decorator_class is not None
        params = self._get_valid_params()
        del params["if_param"]
    ...
    def test_if_param_type_validation(self, load_decorator):
        """Test if_param type validation."""
        decorator_class = load_decorator("Conditional")
        assert decorator_class is not None
        params = self._get_valid_params()
        params["if_param"] = 123
    ...
    def test_then_required(self, load_decorator):
        """Test that then is required."""
        decorator_class = load_decorator("Conditional")
        assert decorator_class is not None
        params = self._get_valid_params()
        del params["then"]
    ...
    def test_then_type_validation(self, load_decorator):
        """Test then type validation."""
        decorator_class = load_decorator("Conditional")
        assert decorator_class is not None
        params = self._get_valid_params()
        params["then"] = 123
    ...
    def test_else_param_type_validation(self, load_decorator):
        """Test else_param type validation."""
        decorator_class = load_decorator("Conditional")
        assert decorator_class is not None
        params = self._get_valid_params()
    ...
    def test_metadata(self, load_decorator):
        ...
        assert metadata["name"] == "Conditional"
