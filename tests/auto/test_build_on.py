...
class TestBuildOn:
    ...
    def test_initialization_default_params(self, load_decorator):
        ...
        assert decorator.name == "BuildOn"

    def test_reference_type_validation(self, load_decorator):
    ...
    def test_reference_enum_validation(self, load_decorator):
        """Test reference enum value validation."""
        decorator_class = load_decorator("BuildOn")
        assert decorator_class is not None
        params = self._get_valid_params()
        params['reference'] = 'invalid_enum_value'
    ...
    def test_approach_type_validation(self, load_decorator):
        """Test approach type validation."""
        decorator_class = load_decorator("BuildOn")
        assert decorator_class is not None
        params = self._get_valid_params()
    ...
    def test_approach_enum_validation(self, load_decorator):
        """Test approach enum value validation."""
        decorator_class = load_decorator("BuildOn")
        assert decorator_class is not None
        params = self._get_valid_params()
        params['approach'] = 'invalid_enum_value'
    ...
    def test_preserveStructure_type_validation(self, load_decorator):
        """Test preserveStructure type validation."""
        decorator_class = load_decorator("BuildOn")
        assert decorator_class is not None
        params = self._get_valid_params()
