...
class TestConstraints:
    ...
    def test_initialization_default_params(self, load_decorator):
        ...
        assert decorator.name == "Constraints"
    ...
    def test_timeframe_type_validation(self, load_decorator):
        """Test timeframe type validation."""
        decorator_class = load_decorator("Constraints")
        assert decorator_class is not None
        params = self._get_valid_params()
    ...
    def test_vocabulary_type_validation(self, load_decorator):
    ...
    def test_vocabulary_enum_validation(self, load_decorator):
        """Test vocabulary enum value validation."""
        decorator_class = load_decorator("Constraints")
        assert decorator_class is not None
        params = self._get_valid_params()
        params['vocabulary'] = 'invalid_enum_value'
    ...
    def test_custom_type_validation(self, load_decorator):
    ...
    def test_metadata(self, load_decorator):
        ...
        assert metadata["name"] == "Constraints"
