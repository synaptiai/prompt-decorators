...
class TestChain:
    ...
    def test_showSteps_type_validation(self, load_decorator):
        """Test showSteps type validation."""
        decorator_class = load_decorator("Chain")
        assert decorator_class is not None
        params = self._get_valid_params()
    ...
    def test_stopOnFailure_type_validation(self, load_decorator):
        """Test stopOnFailure type validation."""
        decorator_class = load_decorator("Chain")
        assert decorator_class is not None
        params = self._get_valid_params()
