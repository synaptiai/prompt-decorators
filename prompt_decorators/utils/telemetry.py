...
class TelemetryManager:
        ...
        try:
            ...
            if os.path.exists(config_path):
                with open(config_path, 'r') as f:
                    ...
                    self._installation_id = config.get("installation_id", self._installation_id)
            else:
    ...
    def track_decorator_combination(
        ...
        Args:
            ...
            prompt_length: Length of the prompt (optional)
            metadata: Additional metadata (optional)
        """
        if not self._enabled:
            return
    ...
    def track_performance(
        ...
        """
        Track performance of a decorator.
        
        Args:
            decorator_name: Name of the decorator
            version: Version of the decorator
            execution_time: Time taken to apply the decorator (in seconds)
            metadata: Additional metadata (optional)
        """
        if not self._enabled:
            return
    ...
    def _queue_event(self, event: Dict[str, Any]) -> None:
        ...
        try:
            # Add installation ID
            event["installation_id"] = self._installation_id
            ...
            logger.warning(f"Error queueing telemetry event: {e}")
    ...
    def _process_event(self, event: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if self._storage_path:
                ...
                filename = f"{event_type}_{timestamp}_{rand_suffix}.json"
