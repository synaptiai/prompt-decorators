...
class DecoratorFactory:
    ...
    def create_from_dict(self, decorator_data: Dict[str, Any]) -> Optional[BaseDecorator]:
        """
    ...
    def find_decorator_class(self, decorator_name: str) -> Optional[Type[BaseDecorator]]:
        """
    ...
    def create_dynamic_class(self, decorator_data: Dict[str, Any]) -> Type[BaseDecorator]:
        """
