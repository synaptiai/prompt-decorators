    ...
    def __init__(
        ...
        if self._level is not None:
            ...
            if self._level not in ["moderate", "high", "scientific"]:
                raise ValidationError(f"The parameter 'level' must be one of the allowed enum values: ['moderate', 'high', 'scientific']. Got {self._level}")
        if self._units is not None:
            if not isinstance(self._units, bool):
                raise ValidationError("The parameter 'units' must be a boolean type value.")
        if self._definitions is not None:
            if not isinstance(self._definitions, bool):
                raise ValidationError("The parameter 'definitions' must be a boolean type value.")
