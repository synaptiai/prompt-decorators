...
import logging
import json
from typing import Dict, List, Any, Optional, Set, Type, Union, cast, TypeVar, Generic

from prompt_decorators.core.base import BaseDecorator
from prompt_decorators.utils.model_detection import ModelCapabilities, get_model_detector
...
class ModelSpecificDecorator(BaseDecorator, Generic[T]):
    ...
    def is_supported_by_model(self) -> bool:
        ...
        if "supported_decorators" in self.model_capabilities.capabilities:
            return self.name in self.model_capabilities.capabilities["supported_decorators"]
...
class ModelSpecificDecoratorFactory:
    ...
    @staticmethod
    def create_for_model(decorator_class: Type[BaseDecorator], model_id: str, **params) -> BaseDecorator:
        """
        ...
        model_specific_class = type(
            ...
            (ModelSpecificDecorator, decorator_class),
            {
                ...
                "apply_for_model": lambda self, prompt: decorator_class.apply(self, prompt),
                "_model_id": model_id
            }
        )
