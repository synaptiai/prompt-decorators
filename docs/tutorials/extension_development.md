...
For detailed information on creating domain-specific extensions, please refer to our [Domain-Specific Extensions Guide](../guides/domain_specific_extensions.md).
...
- [Creating Custom Decorators](creating_custom_decorator.md)
