...
def validate_registry(registry_dir: str = "registry", verbose: bool = False) -> bool:
...
def generate_code(
    ...
    try:
        ...
        logger.error(
            "Make sure prompt-decorators package is installed and in your PYTHONPATH"
        )
        return False
...
def generate_tests(
    ...
    try:
        ...
        logger.info(
            f"✓ Successfully generated {len(generated_files)} test files in {output_dir}"
        )
